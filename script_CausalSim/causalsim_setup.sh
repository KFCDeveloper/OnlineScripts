...
# ln -s abr-puffer/CAUSALSIM_DIR-20-11-27/cooked abr-puffer/CAUSALSIM_DIR-21-3-27/
...
python analysis/original_subset_ssim.py --dir CAUSALSIM_DIR-21-1-27/ --left_out_policy linear_bba # ExpertSim ** need
...
python analysis/tune_buffer_hyperparams.py --dir CAUSALSIM_DIR-20-11-27/
...
python analysis/original_subset_stall.py --dir CAUSALSIM_DIR-20-11-27/ --left_out_policy linear_bba # ExpertSim 
python analysis/sl_subset_stall.py --dir CAUSALSIM_DIR-20-11-27/ --left_out_policy linear_bba  # SLSim 
python analysis/subset_stall.py --dir CAUSALSIM_DIR-20-11-27/ --left_out_policy linear_bba --C 0.05 # CausalSim 
# Tune CausalSim's hyper-parameters for downloadtime prediction
python analysis/tune_downloadtime_hyperparameters.py --dir CAUSALSIM_DIR-20-11-27/  


# draw Fig4
python visualization/fig4_causal_only.py --dir CAUSALSIM_DIR-20-11-27/