#!/bin/bash
# wget -O - https://raw.githubusercontent.com/KFCDeveloper/OnlineScripts/main/script_Sinan/new_script/common.sh | bash
# install conda
cd /mydata
...
/mydata/miniconda3/condabin/conda create --name sinan python=3.7 -y
# conda activate firm
...
# google has deleted old version's kubernetes; we can download old version from Aliyun Cloud Source. https://www.cnblogs.com/cloudnative/p/12979825.html
