...
third_edge_str = sys.argv[4]
network_name = topo_name    # "Abilene"
# remember to modify three places; third_edge_str| "-3-" | third_edge_tuple
dest_dir = network_name + "-obj1-3-" + first_edge_str + "-" + second_edge_str + "-" + third_edge_str # remember to modify three places;  "-squeeze-links-more1"  || + "-" + third_edge_str
...
third_edge_tuple = tuple(third_edge_str.strip("()").replace("'", "").split(", "))  # edges[third_edge_tuple] = 
...
edges[third_edge_tuple] = str(float(edges[third_edge_tuple])/2) # '5000.0'
